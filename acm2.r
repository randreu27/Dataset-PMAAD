...
library("corrplot")
library(readr)
llibres <- read_csv("c:/Users/nils/Documents/Programació/Universitat/Q4/PMAAD/llibres_imputat.csv")
?MCA
...
llibres_acm <- llibres[-c(1, 3, 7, 15)]
# llibres_acm[, cat_cols] <- lapply(llibres_acm[, cat_cols], as.factor)
res.mca0 <- MCA(llibres_acm, quanti.sup=c(1, 4:11, 13:21))
